...
import { MoreFilled, Edit, Download, Right, Delete, CircleCheck, CircleCheckFilled, Share } from '@element-plus/icons-vue'
...
function handleShare() {
  if (contextMenuFile.value) emit('share', contextMenuFile.value)
  hideContextMenu()
}
