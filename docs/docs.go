...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateClipboardRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdatePinRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/files/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "排序方式(relevance/name/size/time)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "handler.CreateClipboardRequest": {
            "type": "object",
            "required": [
                "content"
            ],
